...
| unitPeriodDTOList | List\<UnitPeriodDTO\> | 自定义单位时段列表 |
...
| 名称 | 类型(Java数据结构) | 含义 |
| ---- | ----------------- | ---- |
| periodDTOList | List\<PeriodDTO\> | 收费时段配置列表 |
...
```json
{
    "calcModeFlag": "0",
    "periodDTOList": [
        {"startTime": "0", "endTime": "30", "fee": "0"},
        {"startTime": "30", "endTime": "240", "fee": "5"},
        {"startTime": "240", "endTime": "480", "fee": "10"},
        {"startTime": "480", "endTime": "720", "fee": "15"},
        {"startTime": "720", "endTime": "1440", "fee": "30"}
    ]
}
```
...
| timeDTOList | List\<TimeDTO\> | 收费时段配置列表 |
| calcModeFlag | Integer | 收费计时模式标志位（0：自然天制，1:24小时制） |
...
```json
{
    ...
    "maxFee": null,
    "timeDTOList": [
        {"startTime": "0", "endTime": "480", "fee": "5"},
        {"startTime": "480", "endTime": "720", "fee": "8"},
        {"startTime": "720", "endTime": "1200", "fee": "10"},
        {"startTime": "1200", "endTime": "1439", "fee": "4"}
    ]
}
```
